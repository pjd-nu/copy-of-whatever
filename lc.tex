...
\conferenceinfo{INFLOW'13,} {November 3, 2013, Pennsylvania, USA.} 
\CopyrightYear{2013}
\crdata{978-1-4503-2462-5}
\clubpenalty=10000
\widowpenalty = 10000
...
\alignauthor
Abutalib Aghayev\\
       \affaddr{College of Computer and Information Science}\\
       \affaddr{Northeastern University}\\
       \affaddr{Boston, MA}\\
       \email{aghayev@ccs.neu.edu}
% 2nd. author
\alignauthor
Peter Desnoyers\\
       \affaddr{College of Computer and Information Science}\\
...
\category{D.4.2}{Operating Systems}{Storage Management}[Allocation/deallocation
  strategies]

\terms{Performance, Design, Experimentation}

\keywords{Log-structured, cache, mobile browser, NAND flash, Chromium, Android}
